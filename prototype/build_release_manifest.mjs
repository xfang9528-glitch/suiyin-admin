...
const manifest={tag,spec:'SPEC-SUIYIN-ADMIN-054@1.0.0',baseline:'SPEC-SUIYIN-ADMIN-051@1.1.0',specs:['SPEC-SUIYIN-ADMIN-052@1.1.2','SPEC-SUIYIN-ADMIN-053@1.0.1','SPEC-SUIYIN-ADMIN-054@1.0.0','SPEC-SUIYIN-ADMIN-055@1.0.0','SPEC-SUIYIN-ADMIN-056@1.0.0'],runtime:'static-html',coverage:{tenants:15,routes:84,tenantRoutes:752},generatedAt:new Date().toISOString(),files:hashes};
