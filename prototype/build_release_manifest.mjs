...
const manifest={tag,spec:'SPEC-SUIYIN-ADMIN-068@1.0.0',baseline:'SPEC-SUIYIN-ADMIN-051@1.1.0',specs:['SPEC-SUIYIN-ADMIN-052@1.2.0','SPEC-SUIYIN-ADMIN-053@1.0.2','SPEC-SUIYIN-ADMIN-054@1.0.0','SPEC-SUIYIN-ADMIN-055@1.1.0','SPEC-SUIYIN-ADMIN-056@1.0.0','SPEC-SUIYIN-ADMIN-058@1.2.0','SPEC-SUIYIN-ADMIN-060@1.1.0','SPEC-SUIYIN-ADMIN-062@1.0.0','SPEC-SUIYIN-ADMIN-068@1.0.0'],runtime:'static-html',coverage:{tenants:15,routes:85,tenantRoutes:765},generatedAt:new Date().toISOString(),files:hashes};
