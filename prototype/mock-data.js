...
// ===== 销售账号（艺星线上真实账号 197 条，房总 2026-05-12 截图同步） =====
// 用于 stats_script / stats_invite / sales 等统计页 mock
// dept 按账号命名 pattern 推断分配（自媒体XXX→自媒体；带「（小红书）」/Dr/医生→小红书；
// 艺星专家助理 / 院长助理 / Lucy / 成都艺星医生助理→抖音IP；其他真名按既有归属或轮询补齐），
// 最终归属以房总核对为准
const SALES_ACCOUNTS = [
  // ----- 抖音IP（直播带货 + 院长助理 + 艺星专家助理） -----
  { id:'a001', name:'杜佳',         dept:'抖音IP' },
  { id:'a002', name:'杨瑶 yiyi',    dept:'抖音IP' },
  { id:'a003', name:'罗玲 金金',    dept:'抖音IP' },
  { id:'a004', name:'周恬 Lucy💕', dept:'抖音IP' },
  { id:'a005', name:'唐可欣',       dept:'抖音IP' },
  { id:'a006', name:'曹冰清',       dept:'抖音IP' },
  { id:'a007', name:'成都艺星专家助理鑫鑫',        dept:'抖音IP' },
  { id:'a008', name:'A成都艺星专家助理KK17775575920', dept:'抖音IP' },
  { id:'a009', name:'A成都艺星院长助理好好17713619739', dept:'抖音IP' },
  { id:'a010', name:'YeStar成都艺星专家助理-铃铃',   dept:'抖音IP' },
  { id:'a011', name:'成都艺星医生助理chloe',        dept:'抖音IP' },
  { id:'a012', name:'艺星高级专家助理~多多',        dept:'抖音IP' },
  { id:'a013', name:'艺星高级专家助理-嘉嘉',        dept:'抖音IP' },
  { id:'a014', name:'艺星高级专家助理~小雅',        dept:'抖音IP' },
  { id:'a015', name:'艺星专家助理 Scarlett',        dept:'抖音IP' },
  { id:'a016', name:'艺星专家助理妍妍',             dept:'抖音IP' },
  { id:'a017', name:'艺星专家助理Mia',              dept:'抖音IP' },
  { id:'a018', name:'艺星专家助理Nana',             dept:'抖音IP' },
  { id:'a019', name:'艺星专家助理Umi',              dept:'抖音IP' },
  { id:'a020', name:'艺星专家助理ViVi',             dept:'抖音IP' },
  { id:'a021', name:'艺星专家助理Isla',             dept:'抖音IP' },
  { id:'a022', name:'A成都艺星子苗专家助理',         dept:'抖音IP' },
  { id:'a023', name:'成都艺星专家助理Lucy💕',       dept:'抖音IP' },
  { id:'a024', name:'刘依王01',     dept:'抖音IP' },
  { id:'a025', name:'刘依王02',     dept:'抖音IP' },
  { id:'a026', name:'孙师威01',     dept:'抖音IP' },
  { id:'a027', name:'孙师威02',     dept:'抖音IP' },
  { id:'a028', name:'胡琪01',       dept:'抖音IP' },
  { id:'a029', name:'胡琪02',       dept:'抖音IP' },
  { id:'a030', name:'苏杭1',        dept:'抖音IP' },
  { id:'a031', name:'邓梦雨',       dept:'抖音IP' },
  { id:'a032', name:'马驰 圆圆',    dept:'抖音IP' },
  { id:'a033', name:'佰智德三',     dept:'抖音IP' },
  { id:'a034', name:'李倩',         dept:'抖音IP' },
  { id:'a035', name:'杨亚平',       dept:'抖音IP' },
  { id:'a036', name:'林雪 林林',    dept:'抖音IP' },
  { id:'a037', name:'林雪言希',     dept:'抖音IP' },
  { id:'a038', name:'郑丽',         dept:'抖音IP' },
  { id:'a039', name:'郑丽01',       dept:'抖音IP' },
  { id:'a040', name:'鄢上淞 小涵',  dept:'抖音IP' },
  { id:'a041', name:'陈凤琳',       dept:'抖音IP' },
  { id:'a042', name:'陈凤琳01',     dept:'抖音IP' },

  // ----- 小红书（医生小红书号 + 小红书私域） -----
  { id:'b001', name:'Dr周顺波（小红书）01',     dept:'小红书' },
  { id:'b002', name:'Dr谢雯（小红书）01',       dept:'小红书' },
  { id:'b003', name:'向朝医生（小红书）01',     dept:'小红书' },
  { id:'b004', name:'徐亚红医生（小红书）01',   dept:'小红书' },
  { id:'b005', name:'成都范璨月（小红书）01',   dept:'小红书' },
  { id:'b006', name:'李竞医生（小红书）01',     dept:'小红书' },
  { id:'b007', name:'吉虹蝶01',                 dept:'小红书' },
  { id:'b008', name:'吉虹蝶02',                 dept:'小红书' },
  { id:'b009', name:'张经晶',                   dept:'小红书' },
  { id:'b010', name:'张祖欣01',                 dept:'小红书' },
  { id:'b011', name:'张祖欣02',                 dept:'小红书' },

  // ----- 电商 -----
  { id:'c001', name:'聂敏',         dept:'电商' },
  { id:'c002', name:'黄诗琴',       dept:'电商' },
  { id:'c003', name:'何晓秀',       dept:'电商' },
  { id:'c004', name:'牛海兰01',     dept:'电商' },
  { id:'c005', name:'牛海兰02',     dept:'电商' },
  { id:'c006', name:'牛海兰03',     dept:'电商' },
  { id:'c007', name:'王雅莉',       dept:'电商' },
  { id:'c008', name:'张欣',         dept:'电商' },
  { id:'c009', name:'丁静',         dept:'电商' },
  { id:'c010', name:'刘瑜01',       dept:'电商' },
  { id:'c011', name:'刘瑜02',       dept:'电商' },
  { id:'c012', name:'柳霜01',       dept:'电商' },
  { id:'c013', name:'柳霜02',       dept:'电商' },
  { id:'c014', name:'柳霜03',       dept:'电商' },
  { id:'c015', name:'裴培01',       dept:'电商' },
  { id:'c016', name:'裴培02',       dept:'电商' },
  { id:'c017', name:'曹蕊',         dept:'电商' },
  { id:'c018', name:'曹蕊01',       dept:'电商' },
  { id:'c019', name:'梁慧01',       dept:'电商' },
  { id:'c020', name:'梁慧02',       dept:'电商' },
  { id:'c021', name:'黄诗霞01',     dept:'电商' },

  // ----- 代运营 -----
  { id:'d001', name:'王清清',       dept:'代运营' },
  { id:'d002', name:'董宗梅01',     dept:'代运营' },
  { id:'d003', name:'董宗梅02',     dept:'代运营' },
  { id:'d004', name:'王珊',         dept:'代运营' },
  { id:'d005', name:'颜婷01',       dept:'代运营' },
  { id:'d006', name:'颜婷02',       dept:'代运营' },
  { id:'d007', name:'何紫霞',       dept:'代运营' },
  { id:'d008', name:'杨婧01',       dept:'代运营' },
  { id:'d009', name:'杨婧02',       dept:'代运营' },
  { id:'d010', name:'樊燕玲',       dept:'代运营' },
  { id:'d011', name:'熊隆玲01',     dept:'代运营' },
  { id:'d012', name:'熊隆玲02',     dept:'代运营' },
  { id:'d013', name:'赵紫颖01',     dept:'代运营' },
  { id:'d014', name:'赵紫颖02',     dept:'代运营' },
  { id:'d015', name:'赵紫颖03',     dept:'代运营' },
  { id:'d016', name:'曹琳',         dept:'代运营' },
  { id:'d017', name:'曹琳02',       dept:'代运营' },
  { id:'d018', name:'王雪01',       dept:'代运营' },
  { id:'d019', name:'袁桢妍',       dept:'代运营' },
  { id:'d020', name:'赵学',         dept:'代运营' },
