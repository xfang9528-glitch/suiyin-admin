...
| S004 | 无条件摘要卡/刷新/列设置/分页/空值破折号 | 共享表格与实际字段、动作、分页及空白不一致 | updated | 055规则、054最终结构/控件报告；按来源profile决定样式和能力 | none |
| S005 | 跨租户候选选项与丢失表单 | 参考页结构恢复夹带他租户实体值 | updated | 202套安全结构、1552项结构检查；硬租户页面边界，未采集选项明确提示 | none |
