---
plan_for: SPEC-SUIYIN-ADMIN-056
spec_version: 1.0.0
status: implemented
...
# Prototype Plan — 管理后台聊天配置及仪表盘结构对齐
...
## 4. 文件与路由
admin-domain-views.js、admin-chat.js、admin-expanded-flows.js、admin-sales-dashboard.js/css、data/sales-dashboard、admin-content.html。
## 5. 信息结构
