---
ledger_id: CONVERGENCE-SUIYIN-ADMIN-056
...
| S004 | 聊天、配置、AI统计、好友页通用结构 | 初态、操作、筛选和真实领域页差异 | updated | 专用209项、话术设置255项、好友156项复验；未知展开状态明确未采集 | none |
| S005 | 销售统计简化指标和模拟走势 | 缺失12指标及4排行，无逐点依据却画趋势 | updated | 恢复12指标/4排行；8图逐点数据仍明确未采集；日期与快照一致 | none |
